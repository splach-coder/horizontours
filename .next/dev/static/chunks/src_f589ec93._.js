        ...
        "BookingForm.useEffect": ()=>{
            ...
            if (variants.length > 0 && formData.selectedVariant) {
                ...
                const tier = pricingTiers.find({
                    "BookingForm.useEffect.tier": (p)=>formData.guests >= p.minPeople && formData.guests <= p.maxPeople
                }["BookingForm.useEffect.tier"]);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center gap-2",
                                children: [
                                    pricing.isGroupDiscount && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(BookingForm, "IeBFsLrnsd7fYozuHlcT/HaG6Qs=", false, function() {
    return [
...
function ActivityDetailPage({ params }) {
    ...
    const description = isGroup ? locale === 'fr' ? `Profitez au maximum de votre temps à Marrakech avec nos expériences premium de ${itemType}. Que vous préfériez la brise matinale ou la lumière dorée du coucher de soleil, nous avons l'aventure parfaite pour vous. Roulez à travers la palmeraie ou le désert d'Agafay avec des guides professionnels.` : `Make the most of your time in Marrakech with our premium ${itemType} experiences. Whether you prefer the morning breeze or the golden sunset light, we have the perfect adventure for you. Ride through the palm groves or the Agafay desert with professional guides.` : locale === 'fr' ? `Profitez d'une expérience palpitante de ${itemType} à ${item.location}. Cette activité offre un moyen unique d'explorer le paysage.` : `Enjoy a thrilling ${itemType} experience in ${item.location}. This activity offers a unique way to explore the landscape.`;
...
//# sourceMappingURL=src_f589ec93._.js.map