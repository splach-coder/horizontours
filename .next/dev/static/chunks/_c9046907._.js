...
"[project]/src/app/[locale]/tours/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ToursPage({ params }) {
    ...
    const tours = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "ToursPage.useMemo[tours]": ()=>{
            if (!query) return allTours;
            const q = query.toLowerCase();
            if (q.includes('atlas')) {
                return allTours.filter({
                    "ToursPage.useMemo[tours]": (t)=>t.name.toLowerCase().includes('ourika') || t.name.toLowerCase().includes('imlil') || t.name.toLowerCase().includes('ouzoud')
                }["ToursPage.useMemo[tours]"]);
            }
            return allTours.filter({
                "ToursPage.useMemo[tours]": (t)=>t.name.toLowerCase().includes(q)
            }["ToursPage.useMemo[tours]"]);
        }
    }["ToursPage.useMemo[tours]"], [
        allTours,
...
_s(ToursPage, "fHafHQ82K+r6PMDg29+PmrDZ/lo=", false, function() {
    return [
...
//# sourceMappingURL=_c9046907._.js.map