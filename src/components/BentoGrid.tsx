        ...
        <div className="container mx-auto px-6 md:px-4 py-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 h-auto md:h-[600px]">
                ...
                <BentoItem
                    ...
                    bgImage="/images/merzouga/merzouga1.jpg"
                    delay={0.1}
                />
                ...
                <BentoItem
                    ...
                    bgImage="/images/quad-biking/nils-5RfEgsnxeHo-unsplash.jpg"
                    delay={0.2}
                />
                ...
                <BentoItem
                    ...
                    className="bg-neutral-dark"
                    bgImage="/images/ouarzazate/cristiano-pinto-knB5iCogf5Q-unsplash.jpg"
                    delay={0.3}
                />
            </div>
        </div>
